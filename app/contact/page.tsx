    ...
    <main className="mx-auto w-full max-w-4xl px-6 py-14">
      <div className="mb-10">
        <div className="flex items-center justify-between gap-4">
          <h1 className="text-3xl font-semibold tracking-tight">Contact SpinBook HQ</h1>
        ...
        <p className="mt-3 text-sm opacity-70">
          For bookings, questions, or support, send us a message here. We typically respond within 24 hours.
        </p>
        ...
        <form action={FORM_ACTION} method="POST" className="space-y-5">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <p className="text-xs opacity-60">
              By submitting, you agree SpinBook HQ may contact you regarding your request.
            </p>
